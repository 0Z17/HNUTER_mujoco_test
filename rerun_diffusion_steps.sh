#!/usr/bin/env bash
# Run the diffusion-iteration Rerun replay with zero configuration.
...
output="${DIFFUSION_REPLAY_OUTPUT:-${project_dir}/results/diffusion_steps_replay_${stamp}.rrd}"
...
"${curobo_python}" "${project_dir}/rerun_diffusion_steps.py" \
